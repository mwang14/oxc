...
impl<'a> SemanticBuilder<'a> {
    ...
    #[cfg(feature = "cfg")]
    fn push_function(&mut self, span: Span, is_arrow_expression: bool, is_expression: bool, is_async: bool, is_generator: bool) {
...
impl<'a> Visit<'a> for SemanticBuilder<'a> {
    ...
    fn visit_do_while_statement(&mut self, stmt: &DoWhileStatement<'a>) {
        ...
        let (end_of_condition_graph_ix, end_do_while_graph_ix) = control_flow!(self, |cfg| {
            ...
            cfg.ctx(None)
                ...
                .mark_continue(start_of_condition_graph_ix, EdgeType::Jump(JumpKind::Unconditional))
    ...
    fn visit_for_statement(&mut self, stmt: &ForStatement<'a>) {
        ...
        let after_for_stmt = control_flow!(self, |cfg| {
            ...
            cfg.ctx(None)
                ...
                .mark_continue(update_graph_ix, EdgeType::Jump(JumpKind::Unconditional))
                .resolve_with_upper_label();
            after_for_stmt
        });
    ...
    fn visit_for_in_statement(&mut self, stmt: &ForInStatement<'a>) {
        ...
        let after_for_graph_ix = control_flow!(self, |cfg| {
            ...
            cfg.add_edge(end_of_body_graph_ix, iteration_graph_ix, EdgeType::IterationBackedge);
            ...
            cfg.ctx(None)
                ...
                .mark_continue(iteration_graph_ix, EdgeType::IterationBackedge)
                .resolve_with_upper_label();
            after_for_graph_ix
        });
    ...
    fn visit_arrow_function_expression(&mut self, expr: &ArrowFunctionExpression<'a>) {
        /* cfg */
        self.push_function(expr.span, expr.expression, true, expr.r#async, false);
